...
public class Inventario {
    ...
    public static List<Cancion> Todas() {
        ...
        canciones.add(new Cancion(2,"Caraluna","Bacilos", R.drawable.caraluna,"https://firebasestorage.googleapis.com/v0/b/canciones-mp3.appspot.com/o/Bacilos%20-%20Caraluna.mp3?alt=media&token=31260099-4501-4062-a808-d10e951b03dc"));
        canciones.add(new Cancion(3,"Mientes","Camila", R.drawable.mientes,"https://firebasestorage.googleapis.com/v0/b/canciones-mp3.appspot.com/o/Camila%20-%20Mientes.mp3?alt=media&token=4717edb3-4fa6-4894-bc31-37c68b0b1817"));
        canciones.add(new Cancion(4,"La Flaca","Jarabe De Palo", R.drawable.la_flaca,"https://firebasestorage.googleapis.com/v0/b/canciones-mp3.appspot.com/o/Jarabe%20De%20Palo%20-%20La%20Flaca.mp3?alt=media&token=e0b69114-d2ce-4447-a4d4-0dcdd6b39fd6"));
        canciones.add(new Cancion(5,"I'm Yours","Jason Mraz", R.drawable.im_yours,"https://firebasestorage.googleapis.com/v0/b/canciones-mp3.appspot.com/o/Jason%20Mraz%20-%20Im%20Yours.mp3?alt=media&token=c201120b-1ff4-429d-8a79-4368baf4a7c9"));
        canciones.add(new Cancion(6,"Pursuit Of Happiness","Kid Cudi", R.drawable.pursuit_of_happiness,"https://firebasestorage.googleapis.com/v0/b/canciones-mp3.appspot.com/o/Kid%20Cudi%20-%20Pursuit%20Of%20Happiness.mp3?alt=media&token=a66ab343-3c5d-4ab9-ae22-17fa930da404"));
        canciones.add(new Cancion(7,"La Resaka","Supermerk2", R.drawable.la_resaka,"https://firebasestorage.googleapis.com/v0/b/canciones-mp3.appspot.com/o/la%20resaka-supermerk2.mp3?alt=media&token=da46df14-8a51-4f86-a3f2-e60531905fe7"));
        canciones.add(new Cancion(8,"She Will Be Loved","Maroon 5", R.drawable.she_will_be_loved,"https://firebasestorage.googleapis.com/v0/b/canciones-mp3.appspot.com/o/maroon5_song.mp3?alt=media&token=ec6462fd-ba8a-4560-a5d0-c9a701bcf610"));
